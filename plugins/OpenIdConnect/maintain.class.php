...
class OpenIdConnect_maintain extends PluginMaintain
{
	...
	function install($plugin_version, &$errors=array())
	{
		...
		$query="CREATE TABLE IF NOT EXISTS  `" . $prefixeTable . "oidc` (`sub` VARCHAR(255) CHARACTER SET utf8,`user_id` text CHARACTER SET utf8, UNIQUE KEY `sub` (`sub`)) ENGINE = InnoDB CHARSET=utf8 COLLATE utf8_general_ci;";
		pwg_query($query);
	}
