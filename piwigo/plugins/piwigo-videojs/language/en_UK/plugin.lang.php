...
$lang['CUSTOMCSS_DESC'] = 'Custom CSS (including the open and close style tag) to copy paste from the <a href="http://www.videojs.com/" target="_blank">VideoJS website</a>.';
